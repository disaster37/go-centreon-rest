...
build-mock:
	...
	mockgen --build_flags=--mod=mod -destination=mocks/mock_api.go -package=mocks github.com/disaster37/go-centreon-rest/21.10.x/api API
	mockgen --build_flags=--mod=mod -destination=mocks/mock_service.go -package=mocks github.com/disaster37/go-centreon-rest/21.10.x/api ServiceAPI
