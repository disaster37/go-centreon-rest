...
type HostTemplateResponse struct {
	...
	NormalCheckAttempts       *int     `json:"normal_check_attempts"`
...
// https://docs-api.centreon.com/api/centreon-web/25.10/#tag/Host-template/paths/~1configuration~1hosts~1templates~1{id}/put
