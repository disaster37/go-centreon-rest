...
type MediaCreateResponse struct {
	Result []MediaCreateOrUpdateResponseResult `json:"result"`
...
type MediaCreateOrUpdateResponseResult struct {
	Id        int64  `json:"id"`
...
// MediaCreateOrUpdateResponseError represents an error that occurred during media creation.
...
// MediaListReponse represents a media in Centreon.
type MediaListReponse struct {
	Id        int64  `json:"id"`
